		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory',
		{
			...
			elseif data.current.value == 'open_weapons' then
				...
				ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory2',
				{
					...
					TriggerServerEvent('esx_policejob:giveWeapon', weapon, 250)
				end,
				function(data2, menu2)
					menu2.close()
				end)	
...
AddEventHandler('esx_policejob:hasEnteredEntityZone', function(entity)
	...
	if PlayerData.job ~= nil and (PlayerData.job.name == 'police' or PlayerData.job.name == 'ambulance') and IsPedOnFoot(playerPed) then
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and (PlayerData.job.name == 'police' or PlayerData.job.name == 'ambulance') then
